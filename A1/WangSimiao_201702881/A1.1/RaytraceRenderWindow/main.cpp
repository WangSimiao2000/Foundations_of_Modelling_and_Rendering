...
int main(int argc, char **argv)
    ...
    // 在声明RenderParameters后，调用findLights函数来设置所有的光源
    renderParameters.findLights(texturedObjects);
    // 使用std::cout打印从文件中解析的光源数量
    std::cout << "Number of light sources parsed from the file:" << renderParameters.lights.size() << std::endl;
