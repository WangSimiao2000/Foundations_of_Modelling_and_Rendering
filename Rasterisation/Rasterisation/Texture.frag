...
void main(){
	...
	// vec3 normalDir_VCS = normalVector;
	/* -- Task4 --- END --- */
    ...
    // color = rockColor; // 不加载法线时岩石的blinn-phong颜色
	// color = normalVector; // 不加载法线贴图时的法线颜色
	// color = specular; // 岩石的镜面反射
    // color =  normalDir_VCS; // 加载法线贴图时岩石的法线颜色
